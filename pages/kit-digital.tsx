...
import { firstSlide, secondSlide } from 'components/data'
  ...
  return (
    <main>
      <article className='mx-auto my-0  w-[70%] min-w-[70%] place-content-center lg:w-4/5 md:w-[90%]'>
        ...
        />
        <section>
          <h2 className='mb-8 text-4xl text-center text-gray-500'>¿QUÉ ES EL KIT DIGITAL?</h2>
        ...
        <section>
          <div className='mb-14'>
            <div className='grid grid-cols-2 grid-rows-1'>
              <h2 className='my-auto text-4xl text-right text-gray-500 mr-14'>Requisitos</h2>
        ...
        <section className='bg-gradient-to-r from-cyan-500/30 to-blue-500/30 p-14'>
          <div className='grid grid-cols-2 '>
            <h2 className='mr-8 text-3xl text-right t'>¿Cómo solicito el Bono Digital?</h2>
            <div>
